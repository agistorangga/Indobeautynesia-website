    ...
    <main class="page-category">
        <div class="section">
            <div class="container wide">
                <div class="wrap">
                    <div class="heading">
                        <h1 class="title">{{ count($products) > 0 ? $products[0]->promo_name : 'PROMO' }}</h1>
                    </div>
                    <div class="content">
                                                ...
                                                <ul class="wrapper initial">
                                                    <li>
                                                        @if (request()->get('brand_id') || request()->get('category_id'))
                                                            <a href="{{ url()->full() }}&bundling_id=0">No Bundling</a>
                                                        @else
                                                            <a href="{{ url()->current() }}?bundling_id=0">No Bundling</a>
                                                        @endif
                                                    </li>
                                                    <li>
                                                        @if (request()->get('brand_id') || request()->get('category_id'))
                                                            <a href="{{ url()->full() }}&bundling_id=1">Bundling</a>
                                                        @else
                                                            <a href="{{ url()->current() }}?bundling_id=1">Bundling</a>
                                                        @endif
                                                    </li>
                                                </ul>
                                            </div>
